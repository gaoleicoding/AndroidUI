...
public class VPInfiniteActivity extends Activity implements ViewPager.OnPageChangeListener {
...
//        }
        ...
        viewPager.addOnPageChangeListener(VPInfiniteActivity.this);
        // 设置viewpager在第二个视图显示
    ...
    class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NotNull ViewGroup container, int i) {
            ...
            ImageView imageView = new ImageView(VPInfiniteActivity.this);
            ViewGroup.LayoutParams viewPagerImageViewParams = new ViewGroup.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.MATCH_PARENT);
            imageView.setLayoutParams(viewPagerImageViewParams);
