package com.android.ui.material.behavior2;
...
import com.java.mylibrary.Utils;
...
public class GaodeBottomSheetActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listBehaviorHeight = Utils.dp2px(this, 345);
        setListener();
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (!isSetBottomSheetHeight) {
            ...
            linearParams.height = bottomSheetCoordinatorLayout.getHeight() - Utils.dp2px(this, 90);
            ...
            getWindow().getDecorView().addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
                ...
                public void onLayoutChange(View view, int i, int i1, int i2, int i3, int i4, int i5, int i6, int i7) {
                    ...
                    if (isHasNavigationBar) {
                        ...
                        if (isHid != is) {
                            CoordinatorLayout.LayoutParams linearParams = (CoordinatorLayout.LayoutParams) fraBottomSheet.getLayoutParams();
                            linearParams.height = bottomSheetCoordinatorLayout.getHeight() - Utils.dp2px(GaodeBottomSheetActivity.this, 90);
                            fraBottomSheetHeight = linearParams.height;
                            fraBottomSheet.setLayoutParams(linearParams);
                            isSetBottomSheetHeight = true;
                        }
...
//                Log.i("TAG", "TTTT-----" + newState);
            ...
            public void onSlide(@NonNull View bottomSheet, float slideOffset) {
                ...
                Log.i("TAG", "TTT-----------" + (bottomSheet.getTop() - Utils.dp2px(GaodeBottomSheetActivity.this, 90)) + "---------" + slideOffset);
                if (bottomSheet.getTop() < Utils.dp2px(GaodeBottomSheetActivity.this, 135)) {

                    //设置底栏完全展开时，出现的顶部工具栏的动画
                    designBottomSheetBar.setVisibility(View.VISIBLE);
                    designBottomSheetBar.setAlpha(slideOffset);
                    designBottomSheetBar.setTranslationY(-bottomSheet.getTop() + Utils.dp2px(GaodeBottomSheetActivity.this, 135));
                    llGoldSearchBg.setTranslationY(bottomSheet.getTop() - Utils.dp2px(GaodeBottomSheetActivity.this, 135));
                    if (1 == slideOffset) {
                    ...
                    llGoldSearchBg.setVisibility(View.VISIBLE);
                    llGoldSearchBg.setTranslationY(Utils.dp2px(GaodeBottomSheetActivity.this, 0));
    ...
    public void onClick() {
        ...
        behavior.setPeekHeight((fraBottomSheetHeight - Utils.dp2px(this, 45) > listBehaviorHeight) ? listBehaviorHeight : (int) (fraBottomSheetHeight / 2));
